...
USED_SET_OF_CONFIGURATIONS = 'BE_HSM'

LOGIN_URL = config[USED_SET_OF_CONFIGURATIONS]['LOGIN_URL']
LOGOUT_URL = config[USED_SET_OF_CONFIGURATIONS]['LOGOUT_URL']
ASSERTION_CONSUMER_SERVICE = config[USED_SET_OF_CONFIGURATIONS]['ASSERTION_CONSUMER_SERVICE']
THUMBPRINT = config[USED_SET_OF_CONFIGURATIONS]['THUMBPRINT']
APPLICATION_ID = config[USED_SET_OF_CONFIGURATIONS]['APPLICATION_ID']
